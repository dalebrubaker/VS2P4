...
namespace BruSoft.VS2P4
{
        ...
        IDisposable
    {
        ...
        private PersistedP4OptionSettings persistedSettings;
        ...
        private void StartP4ServiceAndInitializeCache()
        {
            ...
            {
                _solutionPath = persistedSettings.WorkspacePath;
            }
        ...
        public int OnAfterRenameFiles([InAttribute] int cProjects, [InAttribute] int cFiles, [InAttribute] IVsProject[] rgpProjects, [InAttribute] int[] rgFirstIndices, [InAttribute] string[] rgszMkOldNames, [InAttribute] string[] rgszMkNewNames, [InAttribute] VSRENAMEFILEFLAGS[] rgFlags)
        {
            ...
            if (vsSelectionUncontrolled.FileNames.Count > 0 && IsCacheActive())
            {
        ...
        internal P4Options LoadOptions()
        {
            ...
            if (dte2 != null)
            {
                persistedSettings = new PersistedP4OptionSettings(dte2.Globals, defaults);
            }
            else
            {
                persistedSettings = new PersistedP4OptionSettings(defaults);
            }
            Options = P4Options.Load(persistedSettings);
            return Options;
        }
        ...
        internal void SaveOptions(P4Options options)
        {
            ...
            Options = options;
            options.Save(persistedSettings);
            Log.OptionsLevel = options.LogLevel;
        ...
        internal bool IsCacheActive()
        {
            return (_p4Cache != null) && _p4Cache.IsCacheActive;
        }
